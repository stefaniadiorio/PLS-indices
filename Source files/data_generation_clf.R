...
gm1<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.delta=1){
  # define objects
...
gm2<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1){
  # define objects
...
gm2no<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1){
  # define objects1
  lambda.1<-as.matrix(rep(sqrt(1/k), k)) 
...
dgp1<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.delta=1, par.e=0.01){
...
dgp2<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1, par.e=0.01){
  # generate latent variables and metric variables
...
dgp3<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1, par.e=0.01){
  # generate latent variables and metric variables
  yeon<-gm2(n=n, k=k, dist.xi=dist.xi, par.xi.1=par.xi.1, par.xi.2=par.xi.2, par.delta=par.delta/(9*k))
...
dgp4<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1, par.e=0.01){
  # generate latent variables and metric variables
...
dgp5<-function(n=100, k=10, dist.xi=2, par.xi.1=c(-1.44,1.55), par.xi.2=c(-1.44,1.55), par.delta=1, par.e=0.01){
  # generate latent variables and metric variables
  yeon<-gm2no(n=n, k=k, dist.xi=dist.xi, par.xi.1=par.xi.1, par.xi.2=par.xi.2, par.delta=par.delta/(9*k))
